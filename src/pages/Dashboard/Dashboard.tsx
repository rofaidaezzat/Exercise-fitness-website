...
const FitnessDashboard = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-r from-[#000000] to-[#121212] text-white">
      {/* Success Message */}
      {showSuccessMessage && (
        <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 bg-[#1E1E1E] border-2 border-[#FF0000] px-8 py-4 rounded-xl shadow-[0_0_20px_rgba(255,0,0,0.3)] z-50 flex items-center gap-3 animate-slide-up">
          <div className="w-10 h-10 rounded-full bg-[#FF0000] flex items-center justify-center">
            <span className="text-xl">🎉</span>
          </div>
          <div>
            <h3 className="text-lg font-bold text-[#FF0000]">Great Job!</h3>
            <p className="text-white text-sm">You've completed all your tasks!</p>
          </div>
        </div>
      )}
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              {isAuthenticated && (
                <button 
                  ...
                  className="w-8 h-8 rounded-full bg-[#FF0000] flex items-center justify-center hover:bg-[#FF0000]/80 transition-colors"
                >
