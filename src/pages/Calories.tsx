...
const Calories = () => {
  ...
  return (
    <motion.div
      ...
      className="min-h-screen bg-[#121212] text-white flex justify-center px-4 pt-24"
    >
      <motion.div
      ...
      >
        ...
        >
          ...
          >
            ...
            <option value={1.725}>
              Active (daily exercise or intense sessions)
            </option>
            <option value={1.9}>
              Very Active (physical job or 2x/day training)
            </option>
          </select>
        </motion.div>
